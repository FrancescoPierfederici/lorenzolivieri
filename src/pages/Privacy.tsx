      ...
      <div className="section-padding pt-28 sm:pt-32">
        <div className="container-narrow max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-base text-muted-foreground leading-relaxed">
            ...
            <p>
              Il presente sito non utilizza sistemi di intelligenza artificiale con cui l'utente interagisce (chatbot, assistenti virtuali o strumenti simili). Non vengono impiegate tecnologie di riconoscimento emotivo o biometrico, né vengono pubblicati contenuti generati o manipolati da sistemi AI su questioni di interesse pubblico o sotto forma di deepfake.
            </p>
            <p>
              Alcune immagini decorative presenti sul sito (ad esempio lo sfondo della sezione <em>Vincisgrassi &amp; Rock and Roll</em>) sono state generate o elaborate con strumenti di intelligenza artificiale. Questo è indicato in modo chiaro accanto all’immagine interessata, ai sensi dell’articolo 50 del Regolamento (UE) 2024/1689 (AI Act).
            </p>
            <p>
              Le copertine dei libri, le fotografie dell’autore e i contenuti editoriali sono invece materiali originali o di proprietà dell’autore, non generati da sistemi AI.
            </p>
            <p>
